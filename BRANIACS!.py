...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="#00254a", background="#00254a", disabledforeground="#a3a3a3",
        ...
        self.Label1 = tk.Label(self.Canvas1, background="#ffffff", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 13 -weight bold", foreground="#00254a",
...
class Error:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, background="#d3d8dc", borderwidth="1", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 9", foreground="#00254a", highlightbackground="#d9d9d9",
        ...
        self.Label1 = tk.Label(window, background="#f2f3f4", disabledforeground="#a3a3a3", foreground="#00254a",
    ...
    def setMessage(self, message_shown):
        Label2 = tk.Label(master, background="#f2f3f4", disabledforeground="#a3a3a3",
                          font="-family {Segoe UI} -size 16", foreground="#00254a", highlightcolor="#646464646464",
                          text=message_shown)
...
class adminLogin:
    def __init__(self, window=None):
        ...
        global Label2
        Label2 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", foreground="#00254a")
        ...
        self.Entry1 = tk.Entry(Canvas1, background="#e2e2e2", borderwidth="2", disabledforeground="#a3a3a3",
                               font="TkFixedFont", foreground="#00254a", highlightbackground="#b6b6b6",
        ...
        self.Entry1_1 = tk.Entry(Canvas1, show='*', background="#e2e2e2", borderwidth="2",
                                 disabledforeground="#a3a3a3", font="TkFixedFont", foreground="#00254a",
        ...
        self.Label3 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", foreground="#00254a")
        ...
        self.Label4 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", foreground="#00254a")
        ...
        self.Label5 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", foreground="#00254a")
        self.Label5.place(relx=0.670, rely=0.142, height=71, width=74)
        global _img3
        _img3 = tk.PhotoImage(file="")
...
class CustomerLogin:
    ...
    @staticmethod
    def setImg():
        settingIMG = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", foreground="#00254a")
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#00254a",
        ...
        self.Button2 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#00254a",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#fffffe",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
        ...
        self.Button3 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#00254a",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#fffffe",
        ...
        self.Button4 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#00254a",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#fffffe",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
        ...
        self.Button5 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#00254a",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#fffffe",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
        ...
        self.Button6 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#00254a",
...
class CloseAccountByAdmin:
    def __init__(self, window=None):
        ...
        self.Entry1 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3", font="TkFixedFont",
                               foreground="#00254a", insertbackground="black")
        self.Entry1.place(relx=0.536, rely=0.220, height=20, relwidth=0.232)

        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#00254a", borderwidth="0",
        ...
        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="#00254a", background="#004080",
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        self.Entry1 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3", font="TkFixedFont",
                               foreground="#00254a", highlightbackground="#d9d9d9", highlightcolor="black",
        ...
        self.Label1 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#f2f3f4",
                               disabledforeground="#a3a3a3", foreground="#00254a", highlightbackground="#d9d9d9",
        ...
        self.Entry2 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3",
                               font="TkFixedFont", foreground="#00254a", highlightbackground="#d9d9d9",
        ...
        self.Radiobutton1 = tk.Radiobutton(window, activebackground="#ececec", activeforeground="#00254a",
                                           background="#f2f3f4", disabledforeground="#a3a3a3", foreground="#00254a",
        ...
        self.Radiobutton1_1 = tk.Radiobutton(window, activebackground="#ececec", activeforeground="#00254a",
                                             background="#f2f3f4", disabledforeground="#a3a3a3", foreground="#00254a",
                                             highlightbackground="#d9d9d9", highlightcolor="black", justify='left',
        ...
        self.Label5 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#f2f3f4",
                               disabledforeground="#a3a3a3", foreground="#00254a",
        ...
        self.Radiobutton3 = tk.Radiobutton(window, activebackground="#ececec", activeforeground="#00254a",
                                           background="#f2f3f4", disabledforeground="#a3a3a3", foreground="#00254a",
        ...
        self.Radiobutton4 = tk.Radiobutton(window, activebackground="#ececec", activeforeground="#00254a",
                                           background="#f2f3f4", disabledforeground="#a3a3a3", foreground="#00254a",
                                           highlightbackground="#d9d9d9", highlightcolor="black", justify='left',
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#00254a", background="#004080",
                                 borderwidth="0", disabledforeground="#a3a3a3", foreground="#ffffff",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text='''Back''',
                                 command=self.back)
        ...
        self.Label8 = tk.Label(window, background="#f2f3f4", disabledforeground="#a3a3a3", foreground="#00254a",
...
class createAdmin:
    def __init__(self, window=None):
        ...
        self.Label2 = tk.Label(window, background="#f2f3f4", disabledforeground="#a3a3a3", foreground="#00254a",
                               text='''Enter password:''')
...
class customerMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window, relief='groove', font="-family {Segoe UI} -size 13 -weight bold",
                                         foreground="#00254a", text='''Select your option''', background="#fffffe")
        self.Labelframe1.place(relx=0.081, rely=0.081, relheight=0.415, relwidth=0.848)

        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw, activebackground="#ececec",
                                 activeforeground="#00254a", background="#00254a", borderwidth="0",
...
class depositMoney:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, background="#f2f3f4", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 9", foreground="#00254a", borderwidth="0",
                               text='''Enter amount to deposit :''')
        self.Label1.place(relx=0.146, rely=0.171, height=21, width=164)

        self.Entry1 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3", font="TkFixedFont",
                               foreground="#00254a", insertbackground="black", selectforeground="#ffffffffffff")
...
class withdrawMoney:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, background="#f2f3f4", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 9", foreground="#00254a",
